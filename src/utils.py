...
def build_new_alert_guide(indicators_db: dict, example_interval: str = "1h") -> list[str]:
    ...
    header = (
        ...
        "<b>ORB — LuxAlgo Opening Range Breakout (Binance klines):</b>\n"
        "<code>/new_alert PAIR ORB PARAMS DIRECTION [COOLDOWN]</code>\n"
        "Default: 5m range, UTC-4, session 09:30, target 100% of range width\n"
        "DIRECTION: ABOVE (break OR high) | BELOW (break OR low) | BOTH\n\n"
        "<b>Examples — ORB:</b>\n"
        "<code>/new_alert BTC/USDT ORB default BOTH</code>\n"
        "<code>/new_alert BTC/USDT ORB range=15,timezone=-4,session=09:30 ABOVE</code>\n"
        "<code>/new_alert BTC/USDT ORB range=30,timezone=-4,session=09:30,target_pct=100 BELOW</code>\n\n"
